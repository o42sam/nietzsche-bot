...
Run with: export $(cat .env | xargs) && python3 test_groq.py
Or: set -a && source .env && set +a && python3 test_groq.py
"""
import os
import sys
...
def test_groq_api():
    """Test Groq API connection and rephrasing."""
    print("=" * 60)
    print("Testing Groq API (FREE Tier)")
    print("=" * 60)
    print()
    ...
    if not api_key:
        ...
        print("5. Add to .env: GROQ_API_KEY=your_key_here")
        return False

    try:
        # Initialize processor
        print("1. Initializing Groq processor...")
        ...
        if rephrased and len(rephrased) <= 280:
            ...
            print("=" * 60)
            print()
            print("Groq is FAST and FREE - perfect for this bot!")
            return True
        else:
